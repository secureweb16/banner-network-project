        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form id="demo-form" method="post" data-parsley-validate class="form-horizontal form-label-left" action="{{route('admin.users.update',encrypt($user->id))}}">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="name"  name="name" required="required" class="form-control" value="{{@$user->name}}" data-parsley-required-message="user name is required!">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="email" id="email"  name="email" required="required" class="form-control "  value="{{@$user->email}}" data-parsley-required-message="Company email is required!">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="number" id="phoneNumber"  name="phoneNumber" class="form-control " value="{{@$user->mobile_phone}}"  >
                                   ...
                                   <select class="select2_group form-control" name="company_id">
                                      <option value="">Select Company</option>
                                        @forelse($companies as $company)
                                            <option value="{{$company->id}}" {{ $company->id==$user->company->company_id  ? 'selected' : '' }}>{{$company->name}}</option>
                                        @empty
                                        @endforelse
                                    </select>
